...
public class UniformCostSearch {
    ...
    private void readInputFile() throws IOException{
        String newLine;
        String inputPath = "src/files/input.txt";
    ...
    private void outputFile(List<Node> finalList, boolean success){
        PrintWriter writer;
        Node nodeToPrint;
        // print finalQueue
        try {
            writer = new PrintWriter("src/files/output.txt");
            if(success){
...
//				writer.println("-1");
    ...
    private void generateChildren(Node current){
    ...
    private boolean isNotRepeat(Node n, List<Node> checked){
